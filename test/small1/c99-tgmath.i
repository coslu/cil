...
# 29 "c99-tgmath.c"
                      l
# 29 "c99-tgmath.c" 3 4
                      ) != 8) ? (__typeof__ (*(0 ? (__typeof__ (0 ? (double *) 0 : (void *) ((__builtin_classify_type (__real__ ((__typeof__ (+(
# 29 "c99-tgmath.c"
                      l
# 29 "c99-tgmath.c" 3 4
                      ))) 0)) == 8)))) 0 : (__typeof__ (0 ? (__typeof__ ((__typeof__ (+(
...
# 29 "c99-tgmath.c"
                      l
# 29 "c99-tgmath.c" 3 4
                      )) == sizeof (float)) ? (__typeof__ (*(0 ? (__typeof__ (0 ? (double *) 0 : (void *) ((__builtin_classify_type (__real__ ((__typeof__ (+(
# 29 "c99-tgmath.c"
                      l
# 29 "c99-tgmath.c" 3 4
                      ))) 0)) == 8)))) 0 : (__typeof__ (0 ? (__typeof__ ((__typeof__ (+(
...
# 29 "c99-tgmath.c"
                      1
# 29 "c99-tgmath.c" 3 4
                      ) : (__typeof__ (*(0 ? (__typeof__ (0 ? (double *) 0 : (void *) ((__builtin_classify_type (__real__ ((__typeof__ (+(
# 29 "c99-tgmath.c"
                      l
# 29 "c99-tgmath.c" 3 4
                      ))) 0)) == 8)))) 0 : (__typeof__ (0 ? (__typeof__ ((__typeof__ (+(
