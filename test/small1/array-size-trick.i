...
# 10 "array-size-trick.c" 2
# 20 "array-size-trick.c"
...
extern const int _guard[3U - (sizeof(array) / sizeof(array[0]))];
extern const int _guard[(sizeof(array) / sizeof(array[0])) - 3U];
...
main(void)
{
    ...
    return 
# 43 "array-size-trick.c" 3 4
          0
# 43 "array-size-trick.c"
                      ;
}
