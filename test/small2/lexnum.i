...
int main()
{
  ...
  print$Int("10", 10, 10);
  print$Int("010", 010, 8);
  print$Int("0x10", 0x10, 16);
  print$Int("100", 100, 100);
  print$Int("0100", 0100, 64);
  print$Int("0101", 0101, 65);
  print$Int("0x0101", 0x0101, 257);
  print$Int("1 | 64 | 512", 1 | 64 | 512, 577);
  print$Int("01 | 0100", 01 | 0100, 65);
  print$Int("01 | 0100 | 01000", 01 | 0100 | 01000, 577);

  print$Int("0xFFFFFFFF", 0xFFFFFFFF, -1);
  print$Int("0x80000000 | 0x7FFFFFFFU", 0x80000000 | 0x7FFFFFFFU, -1);
  return 0;
}
